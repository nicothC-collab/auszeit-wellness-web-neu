  ...
  return <footer className="bg-auszeit-text text-white py-12">
      <div className="container mx-auto px-4">
        <div className="text-center">
          <div className="mb-6">
            <img alt="Auszeit Logo" src="\"C:\\Users\\nico.thalhammer\\Downloads\\WhatsApp Image 2025-06-08 at 15.30.47.jpeg\"" className="h-16 w-auto mx-auto filter brightness-0 invert opacity-80 object-none" />
          </div>
